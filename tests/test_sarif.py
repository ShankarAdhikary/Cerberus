...
def test_build_sarif_maps_critical_and_high_to_error() -> None:
    findings = [
        {"package": "a", "version": "1.0.0", "vuln_id": "GHSA-1", "severity": "CRITICAL",
         "fixed_version": None, "summary": "s1"},
        {"package": "b", "version": "2.0.0", "vuln_id": "GHSA-2", "severity": "HIGH",
         "fixed_version": "2.0.1", "summary": "s2"},
    ]
...
def test_build_sarif_maps_moderate_to_warning_and_low_unknown_to_note() -> None:
    findings = [
        {"package": "a", "version": "1.0.0", "vuln_id": "GHSA-mod", "severity": "MODERATE",
         "fixed_version": None, "summary": ""},
        {"package": "a", "version": "1.0.0", "vuln_id": "GHSA-low", "severity": "LOW",
         "fixed_version": None, "summary": ""},
        {"package": "a", "version": "1.0.0", "vuln_id": "GHSA-unk", "severity": "UNKNOWN",
         "fixed_version": None, "summary": ""},
    ]
...
def test_build_sarif_dedupes_rules_across_multiple_findings_of_same_id() -> None:
    findings = [
        {"package": "a", "version": "1.0.0", "vuln_id": "GHSA-shared", "severity": "HIGH",
         "fixed_version": "1.0.1", "summary": "shared advisory"},
        {"package": "b", "version": "2.0.0", "vuln_id": "GHSA-shared", "severity": "HIGH",
         "fixed_version": "2.0.1", "summary": "shared advisory"},
    ]
...
def test_build_sarif_result_location_points_at_scanned_file() -> None:
    findings = [
        {"package": "a", "version": "1.0.0", "vuln_id": "GHSA-1", "severity": "HIGH",
         "fixed_version": "1.0.1", "summary": "s"},
    ]
...
def test_build_sarif_message_mentions_package_and_fix() -> None:
    findings = [
        {"package": "lodash", "version": "4.17.15", "vuln_id": "GHSA-1", "severity": "HIGH",
         "fixed_version": "4.17.19", "summary": "issue"},
    ]
...
def test_build_sarif_suppressed_finding_marked_not_omitted() -> None:
    findings = [
        {"package": "a", "version": "1.0.0", "vuln_id": "GHSA-1", "severity": "HIGH",
         "fixed_version": None, "summary": "", "suppressed": True,
