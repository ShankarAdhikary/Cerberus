...
def batch_query(dependencies: List[Dependency], session: Optional[requests.Session] = None) -> Dict[str, set]:
    """
...
def hydrate_vulns(vuln_ids: set, session: Optional[requests.Session] = None) -> Dict[str, dict]:
    """
